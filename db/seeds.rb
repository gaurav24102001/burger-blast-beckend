...
User.create(name: "Timur", username: "BurgerEater", email: "timur_mishiev@yahoo.com", password: "password1" )

User.create(name: "Ira", username: "CookieMonster", email: "ira.mishiev@gmail.com", password: "password2" )

User.create(name: "Dumbo", username: "BigEars", email: "dumbo@gmail.com", password: "password3" )
